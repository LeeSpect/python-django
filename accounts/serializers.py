...
class LoginSerializer(serializers.Serializer):   # 그냥 Serializer는 그냥 틀만 제공, 직접 저장을 해야함
    username = serializers.CharField(max_length=150)
    password = serializers.CharField(max_length=120)
    
class SignupSerializer(serializers.ModelSerializer): #ModelSerializer는 알아서 저장을 해줌
    class Meta:
        model = CustomUser
